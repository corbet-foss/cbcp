...
Checks requiring operator-supplied artifact manifests (`rust-dependencies`) stay
on Crow. Private inputs and publishing
...
| Selector | Coverage |
| --- | --- |
| `metadata` | Version alignment, license inventory, whitespace-free paths and byte-for-byte synchronized license copies |
  ...
  "artifacts": [
    {
      "kind": "wheel",
      "name": "cbcp",
      "path": "/absolute/path/to/verified/cbcp.whl",
